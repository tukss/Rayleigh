Module Controls
    ...
    Logical :: use_cheby_weights = .false.  ! Turn on to integrate using Chebyshev-Gauss quadrature
    Logical :: half_weights = .false.       ! temporary - turn on to use half weighting at boundaries

    Namelist /Numerical_Controls_Namelist/ chebyshev, bandsolve, static_transpose, static_config, &
            & use_parity, deriv_cluge, pad_alltoall, use_cheby_weights, half_weights
