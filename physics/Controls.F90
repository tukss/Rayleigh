Module Controls
	...
	Logical :: lorentz_forces = .false.     ! Turn Lorentz forces on or off
    ...
    Real*8  :: cflmax = 0.1d0, cflmin = 0.05d0  ! Limits for the cfl condition
	Real*8 :: max_time_step = 5.0d-4            ! Maximum timestep to take, whatever CFL says (should always specify this in main_input file)
